...
parser.add_argument('--select', default='', help='view_mode2에서 select할 exon 정의')
parser.add_argument('--train', type=int, default=2, help='view_mode2에서 train할 exon')
parser.add_argument('--test', type=int, default=3, help='view_mode2에서 test할 exon')
