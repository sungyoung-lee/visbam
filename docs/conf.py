...
context = {
    ...
    'downloads': [ 
    ("pdf", "//visbam.readthedocs.io/_/downloads/en/latest/pdf/"),
    ("html", "//visbam.readthedocs.io/_/downloads/en/latest/htmlzip/"),
    ("epub", "//visbam.readthedocs.io/_/downloads/en/latest/epub/"),
    ],
    'subprojects': [ 
    ],
    'slug': 'visbam',
    ...
    'canonical_url': 'https://visbam.readthedocs.io/en/latest/',
    'analytics_code': 'None',
    'single_version': False,
    'conf_py_path': '/docs/',
    'api_host': 'https://readthedocs.org',
    'proxied_api_host': 'https://readthedocs.org',
    'github_user': 'sungyoung-lee',
    'github_repo': 'visbam',
